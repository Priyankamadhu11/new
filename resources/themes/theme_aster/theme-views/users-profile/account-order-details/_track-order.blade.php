                                            ...
                                            <div class="state">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        @else
                                                            <div class="mt-2 fs-12">
                                                                Delivery Duration:    {{$orderDetails->shipping->duration}}<br>

                                                                @php
                                                                    $createdAt = $orderDetails->created_at;
                                                                    list($minDays, $maxDays) = sscanf($orderDetails->shipping->duration, "%d to %d days");
                                                                    $minDeliveryDate = $createdAt->copy()->addDays($minDays);
                                                                    $maxDeliveryDate = $createdAt->copy()->addDays($maxDays);
                                                                @endphp

                                                                Expected Delivery: {{$maxDeliveryDate->format('d M, Y')}}
                                                            </div>
                                                        @endif

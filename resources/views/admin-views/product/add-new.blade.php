            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group mb-0">
                        <label for="name" class="title-color">New Product / Used Product</label>
                        <select class="js-select2-custom form-control" name="used_or_new" required>
                        ...
                        <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" {{ $lang == $default_lang ? 'required' : '' }} name="name[]"
                                        id="{{ $lang }}_name" class="form-control" placeholder="Product Name">
                            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0">{{ translate('Selling_price') }} ({{ \App\CPU\BackEndHelper::currency_symbol() }}) (Including Shipping cost)</label>
                                ...
                                <input type="number" min="0" step="0.01"
                                        placeholder="{{ translate('Selling_price') }}" name="unit_price"
                        ...
                        <!-- <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="shipping_cost">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="0" step="1" placeholder="{{ translate('shipping_cost') }}" name="shipping_cost" class="form-control" >
                            </div>
                        </div> -->

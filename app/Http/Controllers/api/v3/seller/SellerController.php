...
class SellerController extends Controller
{
    ...
    public function seller_info(Request $request)
    {
        ...
        $data['minimum_order_amount'] = \App\CPU\Convert::default($data->minimum_order_amount);
        $data['free_delivery_over_amount'] = \App\CPU\Convert::default($data->free_delivery_over_amount);

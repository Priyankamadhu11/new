...
class ProductController extends Controller
{
    ...
    public function add_new(Request $request)
    {
        ...
        $product->used_or_new = $request->used_or_new;
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'used_or_new.required' => 'Used or New Product is required!',
    ...
    public function get_seller_categories(Request $request)
    {
        ...
        $categoriesWithProducts = Category::whereIn('id', $categoryIds)->get();
        
        $categoriesWithAssociatedProducts = [];
        
        foreach ($categoriesWithProducts as $category) {
            $categoryProducts = $products->where('category_id', $category->id)
                ->map(function ($product) {
                    return $product->only([
                        'id', 'used_or_new', 'name', 'slug', 'product_type',
                        'category_id', 'sub_category_id', 'sub_sub_category_id',
                        'brand_id', 'unit', 'images', 'thumbnail', 'unit_price',
                        'purchase_price', 'code'
                    ]);
                });
        ...
        return response()->json($categoriesWithAssociatedProducts, 200);

                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="form-group">
                                <label class="title-color d-flex align-items-center gap-2">
                                    {{translate('default_commission_days')}}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right">

                                    </span>
                                </label>

                                @php($commission_days=\App\Model\BusinessSetting::where('type','sales_commission_days')->first())

                                <input type="number" class="form-control" name="sales_commission_days" value="{{isset($commission_days)?$commission_days->value:0}}" placeholder="{{translate('ex: 70')}}" min="0" max="100">
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">

                    ...
                    <div class="media flex-wrap align-items-end gap-3 p-2">
                        ...
                        <div class="media-body">
                            <div class="d-flex flex-column align-items-start gap-1 mb-3">
                                ...
                                <a href="{{ route('shopView',['id'=>0,'seller'=>'Zigamart']) }}" target="_blank" class="btn btn--primary d-flex gap-2 align-items-center text-nowrap"><i class="tio-globe"></i>{{translate('visit_website')}}</a>
                            </div>
                        </div>
                    </div>
                </div>

...
class ProductDetailsController extends Controller
{
    ...
    public function product($slug)
    {
        ...
        //dd(2)
       // $formattedSlug = str_replace(' ', '+', Str::slug(strtolower($slug)));
    ...
    public function default_theme($slug){
        ...
        if ($product != null) {
            ...
            $shop = $product->seller->shop; // Retrieve the shop information
//dd($shop);
        return view(VIEW_FILE_NAMES['products_details'], compact('product', 'countWishlist', 'countOrder', 'relatedProducts',
            ...
            'wishlist_status', 'reviews_of_product', 'rating', 'total_reviews', 'products_for_review', 'more_product_from_seller',
            'decimal_point_settings', 'shop'));
    }

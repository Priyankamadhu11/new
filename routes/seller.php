...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'profile', 'as' => 'profile.'], function () {
            ...
            Route::post('send-req-to-delete', 'ProfileController@send_req_to_dlt_account')->name('send_req_to_dlt_account');

            Route::get('refund-policy-edit', 'ProfileController@refund_policy_edit')->name('refund_policy_edit');
            Route::post('refund-policy-update', 'ProfileController@refund_policy_update')->name('refund_policy_update');
            
            Route::put('/save-payment-details', 'ProfileController@saveDetails')->name('save_payment');
        ...
        Route::group(['prefix' => 'brand', 'as' => 'brand.'], function () {
            Route::get('add-new', 'SellerbrandController@add_new')->name('add-new');
            Route::post('add-new', 'SellerbrandController@store');
            Route::get('list', 'SellerbrandController@list')->name('list');
            Route::get('update/{id}', 'SellerbrandController@edit')->name('update');
            Route::post('update/{id}', 'SellerbrandController@update');
            Route::post('delete', 'SellerbrandController@delete')->name('delete');
            Route::get('export', 'SellerbrandController@export')->name('export');
            Route::post('status-update', 'SellerbrandController@status_update')->name('status-update');
        });

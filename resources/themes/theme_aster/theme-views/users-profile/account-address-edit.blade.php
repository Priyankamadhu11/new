                                ...
                                <form action="{{route('address-update')}}" method="post">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <input type="hidden" id="latitude"
                                               ...
                                               placeholder="{{ translate('Ex') }} : -94.22213" value="{{$shippingAddress->latitude??0}}" required readonly>
                                        <input type="hidden"
                                               name="longitude" class="form-control"
                                               placeholder="{{ translate('Ex') }} : 103.344322" id="longitude" value="{{$shippingAddress->longitude??0}}" required readonly>
                                        <div class="col-12">

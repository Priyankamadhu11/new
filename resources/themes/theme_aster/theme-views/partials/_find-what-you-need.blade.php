                                            ...
                                            @foreach($all_category as $key=>$category)
                                                ...
                                                <div class="bg-light rounded p-4">
                                                    <div
                                                        ...
                                                        <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','name'=>$category['name'],'page'=>1])}}" class="btn-link">{{translate('view_all')}}<i
                                                                class="bi bi-chevron-right text-primary"></i></a>
                                                    </div>

                                                    <div class="find-what-you-need-items">
                                                        @foreach($category['childes'] as $key=>$sub_category)
                                                            <a href="{{route('products',['id'=> $sub_category['id'],'data_from'=>'category','name'=>$category['name'],'page'=>1])}}"

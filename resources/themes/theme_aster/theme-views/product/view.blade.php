...
@section('title',translate(str_replace(['-', '_', '/'],' ',$data['name'])))
                                    ...
                                    <ul class="common-nav flex-column nav custom-scrollbar flex-nowrap custom_common_nav">
                                        ...
                                        <li>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <?php
                                                    $categoryWithPlus = str_replace("'", '', str_replace('&', 'and', str_replace(' ', '+', strtolower($category['name']))));

                                                    $cat_url=url('/products') . '?id=' . $category['id'] . '&data_from=category&name=' . $categoryWithPlus . '&page=1';
                                                ?>
                                            ...
                                            <ul class="sub_menu">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between">
                                                        <?php
                                                            $categoryWname= str_replace("'", '', str_replace('&', 'and', str_replace(' ', '+', strtolower($category['name']))));

                                                            $subcategoryNameW = str_replace("'", '', str_replace('&', 'and', str_replace(' ', '+', strtolower($child['name']))));

                                                            $sub_cat_url=url('/products') . '?id=' . $category['id'] . '&data_from=category&name=' . $categoryWname . '&sub='. $subcategoryNameW.'&page=1';
                                                        ?>
                                                        <a href="{{$sub_cat_url}}">{{$child['name']}}</a>
                                                    ...
                                                    <ul class="sub_menu">
                                                        ...
                                                        <li>
                                                            <?php
                                                            $subcategoryName = str_replace("'", '', str_replace('&', 'and', str_replace(' ', '+', strtolower($child['name']))));

                                                             $subcategoryNameWithPlus=str_replace("'", '', str_replace('&', 'and', str_ireplace(' ','+',strtolower($ch['name']))));

                                                             $sub_sub_cat_url=url('/products') . '?id=' . $category['id'] . '&data_from=category&name=' . $subcategoryName . '&sub='. $subcategoryNameWithPlus.'&page=1';
                                                            ?>

                                                            <label class="custom-checkbox">
                                                                <a href="{{$sub_sub_cat_url}}">{{$ch['name']}}</a>
                                                            </label>
                                                        </li>
                                                        @endforeach
                                                    </ul>
                                    ...
                                    <ul class="common-nav nav flex-column pe-2">
                                        ...
                                        <li>
                                            <div class="flex-between-gap-3 align-items-center">
                                                ...
                                                <?php
                                                $brandNameWithPlus = str_replace(' ', '+',  strtolower($brand['name']));
                                                $url = url('/products') . '?id=' . $brand['id'] . '&data_from=brand&name=' . $brandNameWithPlus . '&page=1';
                                            ?>

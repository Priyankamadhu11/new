            ...
            <div class="p-3 p-sm-4">
                <div class="d-flex flex-wrap justify-content-between gap-3 mb-3 mb-sm-4">
                    <div class="d-flex flex-wrap gap-3 align-items-center">
                        <h2><span class="text-primary">{{ translate('top') }}</span> {{ translate('shops') }}</h2>
                    </div>
                                    ...
                                    @if($seller->shop)
                                        <div class="swiper-slide align-items-start bg-light rounded">
                                            ...
                                            <div class="bg-light position-relative rounded p-3 p-sm-4 w-100">
                                                ...
                                                <div class="mb-3">
                                                    <h5 class="mb-1">
                                                        <a href="javascript:" onclick="location.href='{{ route('shopView', ['id' => $seller['id'], 'seller' => $seller->shop->name]) }}'">
    {{ $seller->shop->name ?: 'Zigamart' }}
</a>
                                                            ...
                                                            <a href="{{route('product',$product['slug'])}}"
                                                               class="store-product d-flex flex-column gap-2 align-items-center">
                                                                <div class="store-product__top border rounded">
                                                                    ...
                                                                    <img width="100" style="height: 140px" src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
            ...
            <div class="container">
                <div class="pb-5 rounded position-relative">
                        <a href="{{$banners[5]->url}}">
                            <img src="{{asset('storage/app/public/banner')}}/{{$banners[5]->photo}}" 

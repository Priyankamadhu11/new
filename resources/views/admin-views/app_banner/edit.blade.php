    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-between mb-3">
            <div>
                <h2 class="h1 mb-1 text-capitalize d-flex align-items-center gap-2">
                    ...
                    {{translate('app_banner_update_form')}}
                </h2>
            </div>
            <div>
                <a class="btn btn--primary text-white" href="{{ route('admin.app_banner.list') }}">
        ...
        <div class="row" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.app_banner.update',[$banner['id']])}}" method="post" enctype="multipart/form-data"
                              class="banner_form">
                            @csrf
                            @method('put')
                            <div class="row g-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="banner_type" required id="banner_type_select">
                                            ...
                                            @if(theme_root_path() == 'theme_aster')
                                                ...
                                                <option value="Section Wise Banner" {{$banner['banner_type']=='Section Wise Banner'?'selected':''}}>{{ translate('Section Wise Banner')}}</option>
                                            @endif
                                            @if(theme_root_path() == 'theme_fashion')
                                ...
                                <div class="col-md-6 d-flex flex-column justify-content-center">
                                    <div>
                                        <center class="mx-auto">
                                            <div class="uploadDnD">
                                                <div class="form-group inputDnD input_image input_image_edit" style="background-image: url('{{asset('storage/app/public/app-banner')}}/{{$banner['photo']}}')" data-title="{{ file_exists('storage/app/public/app-banner/'.$banner['photo']) ? '': 'Drag and drop file or Browse file'}}">

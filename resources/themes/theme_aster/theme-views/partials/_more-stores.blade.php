                ...
                <div class="table-responsive hide-scrollbar">
                    <div class="d-flex gap-3 justify-content-between store-list">
                        ...
                        @foreach($more_seller as $seller)
                            ...
                            @php($shopNameWithPlus = str_replace(' ', '+', strtolower($seller->shop->name)))

                            <a href="{{ route('shopView', ['id' => $seller['id'], 'seller' => $shopNameWithPlus]) }}" class="store-product d-flex flex-column gap-3 align-items-center">

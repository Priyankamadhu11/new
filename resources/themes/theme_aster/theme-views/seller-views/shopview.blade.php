...
@push('css_or_js')
    @if($shop->id != 0)
        ...
        <meta property="og:url" content="{{ route('shopView', [$shop->id, 'seller' => $shop->name]) }}">
    @else
    ...
    @if($shop->id != 0)
        ...
        <meta property="twitter:title" content="{{ route('shopView', [$shop->id, 'seller' => $shop->name]) }}"/>
        <meta property="twitter:url" content="{{ route('shopView', [$shop->id, 'seller' => $shop->name]) }}">
    @else
                            ...
                            <div class="">
                                <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                                    <div class="search-box">
                                        ...
                                        <form method="get" action="{{route('shopView',['id' => $seller_id, 'seller' => $shop->name])}}">
                                          <div class="d-flex">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li class="{{$data['data_from']=='latest'? 'selected':''}}">
                                                        <a class="d-flex" href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'data_from'=>'latest','page'=>1])}}">
                                                            {{translate('Latest_Products')}}
                                                        </a>
                                                    </li>
                                                    <li class="{{$data['data_from']=='best-selling'? 'selected':''}}">
                                                        <a class="d-flex" href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'data_from'=>'best-selling','page'=>1])}}">
                                                            {{translate('Best_Selling')}}
                                                        </a>
                                                    </li>
                                                    <li class="{{$data['data_from']=='top-rated'? 'selected':''}}">
                                                        <a class="d-flex" href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'data_from'=>'top-rated','page'=>1])}}">
                                                            {{translate('Top_Rated')}}
                                                        </a>
                                                    </li>
                                                    <li class="{{$data['data_from']=='most-favorite'? 'selected':''}}">
                                                        <a class="d-flex" href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'data_from'=>'most-favorite','page'=>1])}}">
                                                            {{translate('Most_Favorite')}}
                                                        </a>
                                                    </li>
                                                    @if($web_config['featured_deals'])
                                                    <li class="{{$data['data_from']=='featured_deal'? 'selected':''}}">
                                                        <a class="d-flex" href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'data_from'=>'featured_deal','page'=>1])}}">
                                    ...
                                    <ul class="common-nav flex-column nav custom-scrollbar flex-nowrap custom_common_nav">
                                        ...
                                        <li>
                                            <div class="d-flex justify-content-between">
                                                <a href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'category_id'=>$category['id']])}}">{{$category['name']}}</a>
                                            ...
                                            <ul class="sub_menu">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between">
                                                        <a href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'category_id'=>$child['id']])}}">{{$child['name']}}</a>
                                                    ...
                                                    <ul class="sub_menu">
                                                        ...
                                                        <li>
                                                            <label class="custom-checkbox">
                                                                <a href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'category_id'=>$ch['id']])}}">{{$ch['name']}}</a>
                                                            </label>
                                                        </li>
                                                        @endforeach
                                                    </ul>
                                    ...
                                    <ul class="common-nav nav flex-column pe-2">
                                        ...
                                        <li>
                                            <div class="flex-between-gap-3 align-items-center">
                                                <label class="custom-checkbox">
                                                    <a href="{{route('shopView',['id' => $data['id'], 'seller' => $shop->name,'brand_id'=>$brand->id])}}">{{ $brand['name'] }}</a>
                                                </label>

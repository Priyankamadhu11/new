...
@section('title', translate('Seller banner'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 text-capitalize">{{ translate('seller_banner_form')}}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.seller_banner.store')}}" method="post" enctype="multipart/form-data"
                              class="banner_form">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="banner_type" required id="banner_type_select">
                                            ...
                                            @if(theme_root_path() == 'theme_aster')
                                                ...
                                                <option value="section wise Banner">Section Wise Banner</option>
                                            @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select onchange="display_data(this.value)"
                                            ...
                                            <option value="section_add">Advertisement</option>
                                        </select>
                                    </div>
                                ...
                                <tr id="data-{{$banner->id}}">
                                    ...
                                    <td>
                                        <img class="ratio-4:1" width="80"
                                             ...
                                             src="{{asset('storage/app/public/seller-banner')}}/{{$banner['photo']}}">
                                    </td>
                                    <td>{{translate(str_replace('_',' ',$banner->banner_type))}}</td>
                                    <td>
                                        <form action="{{route('admin.seller_banner.status')}}" method="post" id="banner_status{{$banner['id']}}_form" class="banner_status_form">
                                            @csrf
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            <a class="btn btn-outline--primary btn-sm cursor-pointer edit"
                                               ...
                                               href="{{route('admin.seller_banner.edit',[$banner['id']])}}">
                                                <i class="tio-edit"></i>
                                            </a>
...
@push('script')
    ...
    <script>
        ...
        $('.cancel').on('click', function () {
            $('.banner_form').attr('action', "{{route('admin.seller_banner.store')}}");
            $('#main-banner').hide();
        });
        ...
        $('.banner_status_form').on('submit', function(event){
            ...
            $.ajax({
                url: "{{route('admin.seller_banner.status')}}",
                method: 'POST',
                data: $(this).serialize(),
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.seller_banner.delete')}}",
                        method: 'POST',
                        data: {id: id},

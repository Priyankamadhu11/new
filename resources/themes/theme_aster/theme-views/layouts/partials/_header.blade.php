...
<header class="header">
    <div class="header-top py-2">
        <div class="container">
            <div class="d-flex align-items-center flex-wrap justify-content-between gap-2">
                <a href="tel:+{{ $web_config['phone']->value }}" class="d-flex gap-2 align-items-center fw-bold header_link">
                    <i class="bi bi-telephone fw-bold"></i>
                ...
                <ul class="nav justify-content-center justify-content-sm-end align-items-center gap-4">
                    ...
                    <li class="d-none d-xl-block">
                        <a href="{{route('shop.apply')}}" class="d-flex header_link">
                            <div class="fz-16 fw-bold">{{ translate('Become_a_Seller')}}</div>
                        </a>
                    </li>
                    @endif
                </ul>
    ...
    <div class="header-middle py-2 d-none d-xl-block">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between gap-3">
                ...
                <div class="search-box position-relative">
                    <form action="{{route('products')}}" type="submit">
                        <div class="d-flex">
                            <div
                                class="select-wrap focus-border border border-end-logical-0 d-flex align-items-center bg-white">
                    ...
                    <div class="search-card __inline-13 position-absolute z-99 w-100 bg-white top-100 start-0 search-result-box"></div>
                </div>
                    ...
                    @if(auth('customer')->check())
                        <li class="login-register d-flex align-items-center gap-4">
                            <div class="profile-dropdown">
                                <button
                                    type="button"
                                    class="border-0 bg-transparent d-flex gap-2 align-items-center dropdown-toggle text-light p-0 user"
                                    data-bs-toggle="dropdown"
                                    aria-expanded="false"
                                >
                    ...
                    @else
                        <li class="login-register d-flex gap-4">
                            ...
                            >
                                ...
                                <span class="media-body d-none d-xl-block hover-primary fw-bold text-light">{{ translate('login') }} / {{ translate('register') }}</span>
                            </button>
                            <div class="menu-btn d-xl-none">
                                <i class="bi bi-list fs-30"></i>
                            </div>
    ...
    <div class="header-main love-sticky py-2 py-lg-3 py-xl-0 shadow-sm border-top border-dark">
        <div class="container">
            <!-- Aside -->
                        ...
                        <ul class="main-nav nav">
                            <li>
                                ...
                                <ul class="sub_menu">
                                    ...
                                    <?php
                                        $categoryNamehead = str_replace(' ', '+', strtolower($category['name']));
                                        $category_url=url('/products') . '?id=' . $category['id'] . '&data_from=category&name=' . $categoryNamehead .'&page=1';
                                    ?>
                                    <li>
                                        <a href="javascript:">
                                            <span onclick="location.href='{{$category_url}}'">{{ $category['name'] }}</span>
                                        </a>
                                        @if ($category->childes->count() > 0)
                                            <ul class="sub_menu">
                                                ...
                                                <?php
                                                    $subcategoryNamehead = str_replace(' ', '+', strtolower($category['name']));
                                                    $sub_category_url=url('/products') . '?id=' . $subCategory['id'] . '&data_from=category&name=' . $categoryNamehead .'&sub='.$subcategoryNamehead.'&page=1';
                                                ?>
                                                    <a href="javascript:">
                                                        <span onclick="location.href='{{$sub_category_url}}'">{{$subCategory['name']}}</span>
                                                    </a>
                                                    ...
                                                    <ul class="sub_menu">
                                                        @foreach($subCategory['childes'] as $subSubCategory)
                                                            <li>
                                                            <?php
                                                                $subsubcategoryNamehead = str_replace(' ', '+', strtolower($subSubCategory['name']));
                                                                $sub_sub_category_url=url('/products') . '?id=' . $subSubCategory['id'] . '&data_from=category&name=' . $subcategoryNamehead .'&sub='.$subsubcategoryNamehead.'&page=1';
                                                            ?>
                                                                <a href="{{$sub_sub_category_url}}">
                                                                    {{$subSubCategory['name']}}
                                                                </a>
                                                            </li>
                                                        @endforeach
                            ...
                            <li>
                                <a href="javascript:">{{ translate('Shops') }}</a>
                                <!-- Sub Menu -->
                                <ul class="sub_menu">
                                    @foreach($web_config['shops'] as $shop)
                                        <li>
                                            <a href="{{ route('shopView', ['id' => $shop['id'], 'seller' => $shop->seller]) }}">
                            ...
                            <li>
                                ...
                                @foreach($brands as $brand)
                                    <?php
                                        $brandWithPlus = str_replace(' ', '+', strtolower($brand['name']));
                                        $encodedBrandName = rawurlencode($brandWithPlus);
                                    ?>
                                    <li>
                            ...
                            <li>
                                <a class="d-flex gap-2 align-items-center fw-bold" href="{{route('products',['data_from'=>'discounted','page'=>1])}}">
            ...
            <div class="d-flex justify-content-between gap-3 align-items-center position-relative">
                <div class="d-flex align-items-center gap-3">
                            ...
                            @foreach($categories as $key=>$category)
                                @if($key<8)
                                    <li class="{{ $category->childes->count() > 0 ? 'menu-item-has-children':'' }}">
                                                <?php
                                                    $cat_name = str_replace("'", '', str_replace('&', 'and', str_replace(' ', '+', strtolower($category['name']))));
                                                   
                                                    $cate_url=url('/products') . '?id=' . $category['id'] . '&data_from=category&name=' . $cat_name .'&page=1';
                                                ?>
                                        <a href="javascript:" onclick="location.href='{{$cate_url}}'">
                                            {{$category['name']}}
                                        </a>
                                        @if ($category->childes->count() > 0)
                                        <ul class="sub-menu">
                                            ...
                                            <li class="{{ $subCategory->childes->count()>0 ? 'menu-item-has-children':'' }}">
                                                <?php
                                                    $sub_cat_name = str_replace("'", '', str_replace('&', 'and', str_replace(' ', '+', strtolower($subCategory['name']))));
                                                  
                                                    $sub_cate_url=url('/products') . '?id=' . $subCategory['id'] . '&data_from=category&name=' . $cat_name .'&sub='.$sub_cat_name.'&page=1';
                                                ?>
                                                <a href="javascript:" onclick="location.href='{{$sub_cate_url}}'">
                                                    {{$subCategory['name']}}
                                                </a>
                                                @if($subCategory->childes->count()>0)
                                                <ul class="sub-menu">
                                                    @foreach($subCategory['childes'] as $subSubCategory)
                                                        <li>
                                                            <?php
                                                                $sub_sub_cat_name = str_replace("'", '', str_replace('&', 'and', str_replace(' ', '+', strtolower($subSubCategory['name']))));
                                                               
                                                                $sub_sub_cate_url=url('/products') . '?id=' . $subSubCategory['id'] . '&data_from=category&name=' . $sub_cat_name .'&sub='.$sub_sub_cat_name.'&page=1';
                                                            ?>
                                                            <a href="{{$sub_cate_url}}">
                                                                {{$subSubCategory['name']}}
                                                            </a>
                    ...
                    <div class="nav-wrapper">
                        ...
                        <ul class="nav main-menu align-items-center d-none d-xl-flex flex-nowrap text-light">
                            ...
                            @if($web_config['featured_deals']->count()>0 || $web_config['flash_deals'])
                            <li>
                                <a class="cursor-pointer text-light">{{ translate('Offers')}}</a>
                                <ul class="sub-menu">
                                    @if($web_config['featured_deals']->count()>0)
                                        <li>
                            ...
                            @if($web_config['business_mode'] == 'multi')
                            <li>
                                <a class="cursor-pointer fw-bold text-light">{{ translate('Shops') }}</a>
                                <div
                                    ...
                                    <div class="d-flex gap-5">
                                        <div class="column-2 row-gap-3">
                                            @foreach($web_config['shops'] as $shop)
                                             @php($shopWithPlus = str_replace(' ', '+', strtolower($shop->name)))

                                           <a href="{{ route('shopView', ['id' => $shop['id'], 'seller' => $shopWithPlus]) }}" class="media gap-3 align-items-center border-bottom">
                            ...
                            @if($web_config['brand_setting'])
                            <li>
                                <a class="cursor-pointer fw-bold text-light">{{ translate('brands') }}</a>
                                <div class="sub-menu megamenu p-3"
                                    ...
                                    <div class="d-flex gap-4">
                                        <div class="column-2">
                                            ...
                                            <?php
                                                $brandPlus = str_replace(' ', '+',  strtolower($brand['name']));
                                                $url = url('/products') . '?id=' . $brand['id'] . '&data_from=brand&name=' . $brandPlus . '&page=1';
                                            ?>

                                            <a href="{{ $url }}" class="media gap-3 align-items-center border-bottom">
                            ...
                            @if ($web_config['discount_product']>0)
                                <li class="">
                                    <a class="d-flex gap-2 text-light align-items-center fw-bold discount-product-menu {{request()->is('/')?'active':''}}" href="{{route('products',['data_from'=>'discounted','page'=>1])}}">
                                        {{ translate('discounted_products') }}
                ...
                <ul class="list-unstyled list-separator mb-0 pe-2">
                    <li id="blinking-button">
                                <a href="javascript:" class="d-flex gap-2 align-items-center" style="font-weight:800;"  onclick="location.href='{{route('products',['id'=> 1,'data_from'=>'refurbished','page'=>1])}}'">
                    ...
                    <li class="d-none d-xl-block">
                        ...
                        <a href="{{ route('compare-list') }}" class="position-relative">
                            <i class="bi bi-repeat fs-18 text-light"></i>
                    ...
                    <li class="d-none d-xl-block">
                        @if(auth('customer')->check())
                        <a href="{{ route('wishlists') }}" class="position-relative fw-bold">
                            <i class="bi bi-heart fs-18 text-light"></i>
                            <span class="count wishlist_count_status">{{session()->has('wish_list')?count(session('wish_list')):0}}</span>
                        </a>
                        @else
                            <a href="javascript:" class="position-relative fw-bold" data-bs-toggle="modal"
                               data-bs-target="#loginModal">
                                <i class="bi bi-heart fs-18 text-light"></i>
                            </a>
                        @endif
                    ...
                    <li class="d-none d-xl-block fw-bold" id="cart_items">

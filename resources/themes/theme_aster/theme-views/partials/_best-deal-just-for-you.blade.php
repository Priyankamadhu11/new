<section>
    <style>
       a.hover-zoom-in.d-flex.flex-wrap.align-content-between
       {
            border-radius:5px;
            height:80%;
       }
                    ...
                    <div class="p-30">
                        ...
                        <div class="auto-col just-for-you gap-3">
                            ...
                            <a href="{{route('product',$product->slug)}}"
                               class="hover-zoom-in d-flex flex-wrap align-content-between">
                                <div id="produt_showed">
                                    <div class="position-relative" >
                                        ...
                                        <img  src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
                                            ...
                                            loading="lazy" class="dark-support rounded fixed-img" style="height:150px">
                                    </div>
                                </div>

...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <div>
                <a class="btn btn--primary text-white" href="{{ route('admin.seller_banner.list') }}">
        ...
        <div class="row" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.seller_banner.update',[$banner['id']])}}" method="post" enctype="multipart/form-data"
                              class="banner_form">
                            @csrf
                            @method('put')
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 d-flex flex-column justify-content-center">
                                    <div>
                                        <center class="mx-auto">
                                            <div class="uploadDnD">
                                                <div class="form-group inputDnD input_image input_image_edit" style="background-image: url('{{asset('storage/app/public/seller-banner')}}/{{$banner['photo']}}')" data-title="{{ file_exists('storage/app/public/seller-banner/'.$banner['photo']) ? '': 'Drag and drop file or Browse file'}}">

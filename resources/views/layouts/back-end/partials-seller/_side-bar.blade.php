            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <!-- <li class="navbar-vertical-aside-has-menu {{Request::is('seller/profile/refund-policy-edit') || Request::is('seller/profile/refund-policy-edit/*') ?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('seller.profile.refund_policy_edit')}}">
                                <i class="tio-shop nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{translate('Seller Refund Policy')}}
                                </span>
                            </a>
                        </li> -->

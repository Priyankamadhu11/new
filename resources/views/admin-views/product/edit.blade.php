                ...
                <div class="card-body">
                    <div class="form-group mb-0">
                        ...
                        <select class="js-select2-custom form-control" name="used_or_new" required>
                            <option value="0" @if($product->used_or_new == 0) selected @endif>New Product</option>
                            <option value="1" @if($product->used_or_new == 1) selected @endif>Used Product</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color">{{ translate('Selling_price') }} ({{ \App\CPU\BackEndHelper::currency_symbol() }}) (Including Shipping cost)</label>

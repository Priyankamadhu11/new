                                    ...
                                    {{--  --}}
                                        ...
                                        @if ($orderDetails->delivery_type == 'third_party_delivery')
                                            <div class="mt-1">
                                                ...
                                                <span class="d-flex align-items-center justify-content-sm-center text-nowrap">
                                                <span class="text-muted fs-14 text-capitalize"> {{translate('tracking_ID')}} : </span>
                                                <span class="fs-14 fw-semibold text-dark">{{$orderDetails->third_party_delivery_tracking_id}}</span><br>
                                                <span class="text-muted fs-14 text-capitalize"> {{translate('tracking_url')}} : </span>
                                                <span class="fs-14 fw-semibold text-dark">{{$orderDetails->third_party_delivery_tracking_url}}</span>
                                                </span>
                                            </div>
                                        @endif

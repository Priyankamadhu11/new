                                ...
                                <div class="p-2 bg-light rounded">
                                    <div class="media m-1 gap-3">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="fz-12 title-color">{{translate('track_ID')}} :  {{$order->third_party_delivery_tracking_id}}</span><br>
                                            <span class="fz-12 title-color">{{translate('track_url')}} :  {{$order->third_party_delivery_tracking_url}}</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div class="col-12">
                            <form action="{{route('admin.orders.update-deliver-info')}}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="">{{translate('tracking_url')}} ({{translate('optional')}})</label>
                                        <input class="form-control" type="text" name="third_party_delivery_tracking_url" value="{{$order['third_party_delivery_tracking_url']}}" id="">
                                    </div>

    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <!-- Card -->
                <div id="deleteDiv" class="card mb-3 mb-lg-5">
                    <div class="card-header">
                        <h5 class="mb-0">Request to delete my account</h5>
                    </div>
                    <div class="card-body">
                        <form  action="{{route('seller.profile.send_req_to_dlt_account')}}"
                              method="post">
                        @csrf
                        <input type="hidden" value="{{$data->id}}" name="seller_id" >
                            <div class="row form-group flex-nowrap">
                                <label for="reason_for_delete"
                                        class="col-sm-3 col-form-label input-label">Reason</label>
                                <input type="text" class="form-control" name="reason_for_delete" id="reason_for_delete" placeholder="">
                            </div>

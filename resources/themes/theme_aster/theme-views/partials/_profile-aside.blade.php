    ...
    <div class="card profile-sidebar-sticky">
        <div class="card-body position-relative">
            <div class="d-none d-lg-flex justify-content-end">
                <div class="dropdown">
                    <button class="btn-circle p-0 bg-primary absolute-white" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="--size: 1.5rem">
                        <i class="bi bi-trash fs-15 grid-center"></i>
                    </button>

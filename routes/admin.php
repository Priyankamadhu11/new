...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'sub-category', 'as' => 'sub-category.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('edit/{id}', 'SubCategoryController@edit')->name('edit');
        ...
        Route::group(['prefix' => 'sub-sub-category', 'as' => 'sub-sub-category.','middleware'=>['module:product_management']], function () {
            ...
            Route::post('edit/{id}', 'SubSubCategoryController@edit')->name('edit');
        ...
        Route::group(['prefix' => 'app_banner', 'as' => 'app_banner.','middleware'=>['module:promotion_management']], function () {
            Route::post('add-new', 'AppBannerController@store')->name('store');
            Route::get('list', 'AppBannerController@list')->name('list');
            Route::post('delete', 'AppBannerController@delete')->name('delete');
            Route::post('status', 'AppBannerController@status')->name('status');
            Route::get('edit/{id}', 'AppBannerController@edit')->name('edit');
            Route::put('update/{id}', 'AppBannerController@update')->name('update');
        });

        Route::group(['prefix' => 'seller_banner', 'as' => 'seller_banner.','middleware'=>['module:promotion_management']], function () {
            Route::post('add-new', 'SellerBannerController@store')->name('store');
            Route::get('list', 'SellerBannerController@list')->name('list');
            Route::post('delete', 'SellerBannerController@delete')->name('delete');
            Route::post('status', 'SellerBannerController@status')->name('status');
            Route::get('edit/{id}', 'SellerBannerController@edit')->name('edit');
            Route::put('update/{id}', 'SellerBannerController@update')->name('update');
        });
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('seller_delete', 'SellerController@delete_seller')->name('delete_seller');

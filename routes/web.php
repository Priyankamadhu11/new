...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode','guestCheck']], function () {
    ...
    Route::get('seller-refund-policy/{id}', 'PageController@seller_refund_policy')->name('seller_refund_policy');
    ...
    Route::get('used-products', 'ProductListController@used_products')->name('used_products');
    ...
    //sellerShop
    Route::get('shops/{id}/{seller}', 'ShopViewController@seller_shop')->name('shopView');
   //Route::get('shops/{id}-{shopname}', 'ShopViewController@seller_shop')->name('shopView');
    ...
    Route::post('shops/{id}', 'WebController@seller_shop_product');
